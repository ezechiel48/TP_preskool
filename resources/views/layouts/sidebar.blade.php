            ...
            <ul>
                ...
                <li class="submenu active">
                    ...
                    <ul style="display: block;">
                        <li><a href="{{route('departement.list')}}" class="">Department List</a></li>
                        <li><a href="{{route('departement.add')}}">Department Add</a></li>
                        <li><a href="{{route('departement.edit')}}">Department Edit</a></li>
                    </ul>
                </li>
                <li class="submenu">
